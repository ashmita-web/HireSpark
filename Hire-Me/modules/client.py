...
def available():
    ...
    search = Button(rt, text="Sort", font=('normal', 12, 'bold'),
                    bg="#8B0000", fg="#000000", command=lambda: sort_alljobs(table))
    search.grid(row=0, column=3, padx=10, pady=10, ipadx=15)

    apl = Button(rt, text="Apply", font=('normal', 12, 'bold'),
                             bg="#8B0000", fg="#000000", command=lambda: apply(table))
...
def myapp():
    ...
    search_d.current(0)
    search_d.grid(row=0, column=2, padx=0, pady=10)
    search = Button(rt, text="Sort", font=('normal', 12, 'bold'), bg="#8B0000", fg="#000000", command=lambda: sort_myapplications(table))
    search.grid(row=0, column=3, padx=10, pady=10, ipadx=15)
...
def cli(root, email1):
    ...
    # Logout Button with darker color
    bn = Button(root, text="LOGOUT", font=('normal', 20),
                bg="#A00000", fg="#000000",  # Darker red
                activebackground="#B00000",  # Slightly lighter on hover
                relief="raised",
    ...
    pj = Button(lf, text="Available Jobs", font=('normal', 20),
                bg="#A00000", fg="#000000",  # Darker red
                activebackground="#B00000",  # Slightly lighter on hover
                relief="raised",
                command=available)
    ...
    ap = Button(lf, text="My Applications", font=('normal', 20),
                bg="#A00000", fg="#000000",  # Darker red
                activebackground="#B00000",  # Slightly lighter on hover
                relief="raised",
                command=myapp)
    ...
    # Background Label for right area
