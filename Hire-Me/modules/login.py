...
def log(root):
    ...
    btn = Button(f1, image=f1.bn, bg='#00459A', fg='white', bd=0,  # Change background to dark blue
             activebackground="#00459A", command=lambda: submit(root))
    btn.place(x=820, y=420)

    f1.bn1 = PhotoImage(file="elements/reg.png")
    btn1 = Button(f1, image=f1.bn1, bg='#00459A', fg='white', bd=0,  # Change background to dark blue
               activebackground="#00459A", command=lambda: reg(root))
